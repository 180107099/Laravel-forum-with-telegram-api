                ...
                <tbody>
                  <tr>
                    ...
                    <td class="post-col d-lg-flex justify-content-lg-between">
                      ...
                      <div>
                        <span class="font-weight-bold">Posted:</span> {{$reply->created_at->diffForHumans()}}
                      </div>
                      @if(auth()->id()==$reply->user_id )
                      <div><a href="{{route('reply.delete', $reply->id)}}" ><i class="fa fa-trash text-danger"></i></a></div>
                     @else 
                     <div>
                     <a href="{{route('reply.like', $reply->id)}}" class="mr-3" ><i class="fa fa-thumbs-up text-success"></i>20</a>
                     <a href="{{route('reply.dislike', $reply->id)}}" ><i class="fa fa-thumbs-down text-danger">5</i></a>
                     </div>
